...
const Navbar = ({ activeSection, isMenuOpen, setIsMenuOpen, scrollToSection }) => (
  <nav className="fixed top-0 z-50 w-full px-4 pt-4">
    <div className="max-w-6xl mx-auto">
      <div className="flex items-center justify-between h-16 px-4 border shadow-2xl rounded-2xl bg-white/10 backdrop-blur-xl border-white/20 shadow-purple-950/10 sm:px-5">
        ...
        <div className="hidden items-center gap-1 rounded-full border border-white/15 bg-white/10 p-1 md:flex">
        ...
        <button
          className="inline-flex items-center justify-center w-10 h-10 text-white transition-all border rounded-full md:hidden border-white/20 bg-white/10 hover:bg-white/15"
    ...
    {isMenuOpen && (
      <div className="max-w-6xl mx-auto mt-2 overflow-hidden border shadow-2xl md:hidden rounded-2xl bg-white/10 backdrop-blur-xl border-white/20 shadow-purple-950/10">
